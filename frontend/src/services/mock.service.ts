...
const mockRecipes: Recipe[] = [
  {
    ...
    ingredientes:
      '2 xícaras de farinha de trigo, 1 xícara de açúcar, 1/2 xícara de cacau em pó, 3 ovos, 1 xícara de leite, 1/2 xícara de óleo, 1 colher de sopa de fermento em pó',
    userId: 1,
  ...
  },
  {
    ...
    ingredientes:
      '4 filés mignon (150g cada), 1 xícara de vinho tinto, 2 colheres de sopa de cebola picada, 2 dentes de alho, 2 colheres de sopa de manteiga, sal e pimenta a gosto',
    userId: 1,
  ...
  },
  {
    ...
    porcoes: 6,
    modoPreparo:
      '1. Prepare o molho bolonhesa refogando a carne.\n2. Faça o molho bechamel.\n3. Monte a lasanha em camadas.\n4. Asse a 180°C por 45 minutos.\n5. Deixe descansar 10 minutos antes de servir.',
    ingredientes:
      '500g massa para lasanha, 500g carne moída, 2 xícaras molho de tomate, 500g queijo muçarela, 2 xícaras leite, 2 colheres de sopa farinha de trigo, cebola, alho, sal, orégano',
    userId: 1,
  ...
  },
  {
    ...
    porcoes: 4,
    modoPreparo:
      '1. Lave e seque as folhas de alface.\n2. Prepare o molho misturando todos os ingredientes.\n3. Monte a salada com os croutons.\n4. Regue com o molho e sirva.',
    ingredientes:
      '1 alface romana, 1/2 xícara croutons, 1/4 xícara queijo parmesão ralado, 2 colheres de sopa maionese, 1 dente de alho, suco de 1 limão, 2 colheres de sopa azeite, sal e pimenta',
    userId: 1,
  ...
  },
  {
    ...
    ingredientes:
      '2 batatas, 2 cenouras, 1/2 repolho, 1 cebola, 2 dentes de alho, 2 litros de água, sal, cheiro-verde, azeite',
    userId: 1,
  ...
  },
  {
    ...
    ingredientes:
      '1 xícara arroz arbóreo, 200g cogumelos, 1 litro caldo de legumes, 1/2 xícara vinho branco, 1 cebola, 2 dentes de alho, 1/2 xícara queijo parmesão, manteiga',
    userId: 1,
...
export class MockService {
  ...
  static async getRecipes(filters?: {
    categoriaId?: number
    nome?: string
  }): Promise<DefaultResponse<Recipe[]>> {
  ...
  static async getRecipesPaginated(
    page: number,
    limit: number,
    filters?: { categoriaId?: number; nome?: string },
  ...
  static async getCategoriesCount(): Promise<DefaultResponse<CategoryWithCountDto[]>> {
    await this.delay(500)

    const categoriesWithCount = mockCategories.map((category) => ({
      ...category,
      receitasContagem: mockRecipes.filter((recipe) => recipe.categoriaId === category.id).length,
    }))

    return {
      response: categoriesWithCount,
      message: 'Categorias com contagem listadas com sucesso',
      status: true,
    }
  }
  ...
  ): Promise<DefaultResponse<Category>> {
