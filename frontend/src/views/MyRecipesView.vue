  ...
  <v-container>
    ...
    <v-dialog v-model="deleteDialog" max-width="400">
      <v-card>
        ...
        <v-card-text>
          Tem certeza que deseja excluir a receita "{{ recipeToDelete?.nome }}"?
...
// Como o backend não tem filtro por userId, vamos simular que todas as receitas são do usuário logado
